    ...
    <v-row>
      <v-col cols="12" sm="6" md="4" lg="3">
        <v-card class="rounded-lg h-100 info-card d-flex flex-column" min-height="130">
          <v-card-title class="grey--text text--darken-3 text-h5">Storage</v-card-title>
      ...
      <v-col cols="12" sm="6" md="4" lg="3">
        <v-card class="rounded-lg h-100 info-card d-flex flex-column" min-height="130">
          <v-card-title class="grey--text text--darken-3 text-h5">Shared</v-card-title>
          <v-card-text class="text-h6 grey--text d-flex font-weight-regular justify-space-between">
            <span>
              <span class="text-h4 primary--text">100</span> Files
            </span>
            <span>
              <span class="text-h4 primary--text">60</span> Folders
            </span>
          </v-card-text>
        </v-card>
      </v-col>
      ...
      <v-card>
        ...
        <v-container class="py-0">
          <v-form v-model="valid">
            <v-col cols="12">
              <v-text-field
                :rules="[rules.required('Board Name'), rules.length('Board Name', 10)]"
                v-model="boardName"

...
import { m as joinRelativeURL, u as useRuntimeConfig, n as getResponseStatusText, o as getResponseStatus, p as encodePath, q as defineRenderHandler, v as getQuery, w as createError, x as getRouteRules, y as joinURL, b as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"A Collaborative Whiteboard / Sketchboard"}],"link":[{"rel":"icon","type":"image/png","href":"/sb-logo.png"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@300;400;500;600;700&display=swap"}],"style":[],"script":[],"noscript":[],"title":"SpotBrush"};

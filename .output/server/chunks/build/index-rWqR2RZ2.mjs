...
import { defineComponent, computed, withCtx, createTextVNode, unref, createVNode, toDisplayString, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrInterpolate } from 'vue/server-renderer';
import { B as useRoute$1, k as VContainer, l as VRow, m as VCol, V as VCard, p as VCardTitle, q as VCardText } from './server.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(ssrRenderComponent(VCardText, { class: "text-center" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(` We&#39;ve sent a confirmation email to <strong class="text-primary"${_scopeId5}>${ssrInterpolate(unref(email))}</strong>.<br${_scopeId5}> Please check and confirm your registration. `);
                                  } else {
                                    return [
                                      createTextVNode(" We've sent a confirmation email to "),
                                      createVNode("strong", { class: "text-primary" }, toDisplayString(unref(email)), 1),
                                      createTextVNode("."),
                                      createVNode("br"),
                              ...
                              _push5(ssrRenderComponent(VCardText, { class: "text-center text-body-1 px-0" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(` Already confirmed? `);
                                    _push6(ssrRenderComponent(_component_NuxtLink, { to: "/auth/signin" }, {
                                    ...
                                    return [
                                      createTextVNode(" Already confirmed? "),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/auth/confirm/[email]/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-rWqR2RZ2.mjs.map

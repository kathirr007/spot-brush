            ...
            if (_push3) {
              _push3(ssrRenderComponent(VCol, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div class="w-100 text-center text-sm-left"${_scopeId3}><h1${_scopeId3}>SpotBrush Service</h1><p${_scopeId3}>Lorem ipsum sit dolor amet nuev done</p>`);
                    ...
                    return [
                      createVNode("div", { class: "w-100 text-center text-sm-left" }, [
                        createVNode("h1", null, "SpotBrush Service"),
...
//# sourceMappingURL=service-DjTj71BD.mjs.map
